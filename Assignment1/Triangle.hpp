...
class Triangle
{
  public:
    ...
    [[nodiscard]] Eigen::Vector3f a() const { return v[0]; }
    [[nodiscard]] Eigen::Vector3f b() const { return v[1]; }
    [[nodiscard]] Eigen::Vector3f c() const { return v[2]; }
    ...
    [[nodiscard]] std::array<Vector4f, 3> toVector4() const;
};
